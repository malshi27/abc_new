...
const Contact = () => {
    ...
    const onSubmit = (data) => {
        ...
        contact(data);  // Call the contact mutation with form data
    ...
    useEffect(() => {
        ...
        if (isError && error) {
            message.error(error?.data?.message || "Error sending message");
        }
    }, [isSuccess, isError, error]);  // Add dependencies for re-triggering
                ...
                <div>
                    <div className="container">
                        <iframe
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63480.83754043947!2d80.17079707013771!3d6.055975350251288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae173bb6932fce3%3A0x4a35b903f9c64c03!2sGalle!5e0!3m2!1sen!2slk!4v1710315094917!5m2!1sen!2slk"
                            frameBorder="0"
                            allowFullScreen
                        ></iframe>
                    </div>
